...
namespace Cars_Racing.Vehicle.Car
{
    public static class CarConstants
    {
        ...
        public static AnimationCurve RPMPowerToGearSpeedCurve = new AnimationCurve(new Keyframe(0.1f, 0f), new Keyframe(0.2f, 1), new Keyframe(0.8f, 1), new Keyframe(1, 0));
